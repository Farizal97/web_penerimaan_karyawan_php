                ...
                <div class="col-md-12">
                    <table id="example" class="table table-responsive table-hover" cellspacing="0" width="100%"  >
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM master_pelamar where keterangan='Lulus'"; // Query untuk menampilkan semua data lowongan
                            ...
                            ?>
                                ...
                                <tr scope="row">
                                    ...
                                    <td><?php echo $data ['jurusan']; ?></td>
                                      ...
                                      <?php 
                                       echo "<td>
                                                  <a href='lihat_plmr_l.php?id_pelamar=".$data['id_pelamar']."'>Lihat |
