...
<html lang="en">
  ...
  <!-- formulir -->
   <div class="container">
     <form action="proses_ubah.php?id_pelamar=<?php echo $id_pelamar; ?>" method="post">

       <div class="form-group row">
              <label name="posisi_pekerjaan" class="col-sm-2 col-form-label">Posisi Pekerjaan</label>
           <div class="col-sm-10">
              <input type="text" class="form-control" name="nama" value="<?php echo $data['posisi_pekerjaan']; ?> ">
          </div>
       </div>
       ...
       <div class="form-group row">
           ...
           <div class="col-sm-10">
              <input type="text" class="form-control" name="nama" value="<?php echo $data['lokasi_seleksi']; ?> ">             
          </div>
       </div>
      ...
      <div class="form-group row">
       ...
       <div class="form-group row">
          ...
          <div class="col-sm-4">
            <textarea class="form-control" name="alamat_ortu" rows="3"><?php echo $data['alamat_ortu']; ?></textarea>
          </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-7 col-sm-3">
            <textarea class="form-control" name="alamat_kel" rows="3"><?php echo $data['alamat_kel']; ?></textarea>
        </div>
      </div>
      ...
      <div class="form-group row">
       <div class="col-sm-2">
          ...
          <div class="col-sm-10">
            ...
            <a class="btn btn-primary" href="index.php" role="button">Batal</a>
          </div>              
   </div>
